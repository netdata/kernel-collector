...
enum netdata_ebpf_kernel_versions {
    NETDATA_EBPF_KERNEL_4_11 = 264960,  //  264960 = 4 * 65536 + 11 * 256
    NETDATA_EBPF_KERNEL_4_14 = 265728,  //  265728 = 4 * 65536 + 14 * 256
...
enum netdata_thread_flag {
    ...
    NETDATA_FLAG_NETWORK_VIEWER = 1 << 10,
    NETDATA_FLAG_OOMKILL = 1 << 11,
    NETDATA_FLAG_PROCESS = 1 << 12,
    NETDATA_FLAG_SHM = 1 << 13,
    NETDATA_FLAG_SOCKET = 1 << 14,
    NETDATA_FLAG_SOFTIRQ = 1 << 15,
    NETDATA_FLAG_SWAP = 1 << 16,
    NETDATA_FLAG_VFS = 1 << 17,
    NETDATA_FLAG_NFS = 1 << 18,
    NETDATA_FLAG_XFS = 1 << 19,
